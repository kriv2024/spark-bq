...
@click.option('--mode', default='overwrite', 
...
@click.option('--app-name', default='pyspark-bigquery-job', help='Spark application name')
def submit_job(source_table, target_table, filter_condition, mode, partition_by, app_name):
